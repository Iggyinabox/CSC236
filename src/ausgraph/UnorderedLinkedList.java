...
public class UnorderedLinkedList<T> extends LinkedListClass<T>
{
    ...
    public void insertFirst(T newItem, T name){
        LinkedListNode<T> newNode;    

        newNode = new LinkedListNode<T>(newItem, name, first); 
    ...
    public void insertLast(T newItem, T name){
        LinkedListNode newNode; 

        newNode = new LinkedListNode(newItem, name, null);  //create newNode
